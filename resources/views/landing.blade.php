        ...
        <nav id="cbx-header" class="navbar navbar-default cbx-header">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand cbx-logo gotome" href="{{ url('/') }}">Landing<span>​‌Ž</span></a>
                </div>
        ...
        <section id="cbx-parallax-banner">
            <div class="cbx-section">
                <div id="layer-wrapper" class="cbx-item-parallax-banner">
                    ...
                    <div id="object6" class="rightlayer2shade hidden-sm hidden-xs"></div>
                    <div id="object7" class="rightlayer2 hidden-sm hidden-xs"></div>
                    <div id="object8" class="rightlayer3shade hidden-sm hidden-xs"></div>
                    <div id="object9" class="rightlayer3 hidden-sm hidden-xs"></div>
